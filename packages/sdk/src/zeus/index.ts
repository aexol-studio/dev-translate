...
export type ValueTypes = {
  ...
  ['StripeMutation']: AliasType<{
    buyProduct?: [
      { productId: string | Variable<any, string>; quantity: number | Variable<any, string> },
      boolean | `@${string}`,
    ];
    __typename?: boolean | `@${string}`;
  }>;
...
export type ResolverInputTypes = {
  ...
  ['ApiMutation']: AliasType<{
    translate?: [
      { translate: ResolverInputTypes['TranslateInput']; name?: string | undefined | null },
  ...
  ['ApiQuery']: AliasType<{
    predictTranslationCost?: [
      ...
      ResolverInputTypes['PredictionResponse'],
    ];
